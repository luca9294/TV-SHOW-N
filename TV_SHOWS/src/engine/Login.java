...
public class Login {
	...
	public Login(String user,String passwd,Context context) throws InterruptedException, ExecutionException, JSONException {
	this.user = user;
	this.passwd = passwd;
...
class DataGrabber extends AsyncTask<String, Void, JSONObject> {
	...
	protected JSONObject doInBackground(String... params) {
	    ...
	    try {
			 data = getDataFromJSON("http://api.trakt.tv/account/test/361cd031c2473b06997c87c25ec9c057", true, "",null);
	...
	public JSONObject getDataFromJSON(String url, boolean login, String type,
			JSONObject postdata) throws JSONException, ClientProtocolException, IOException {
