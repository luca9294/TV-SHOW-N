...
public class SaveToCalendar {
	...
	public SaveToCalendar(String title, String description, int year, int day, int month, int hour, int minutes, int runtime, Activity ac){
		activity = ac;
		
		SetCalendarEvent(title, description, year, day, month, hour, minutes, runtime);
	}
