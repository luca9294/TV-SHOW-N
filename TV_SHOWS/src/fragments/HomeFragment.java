...
public class HomeFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try {
			...
			customAdapter = new CustomAdapter(vector.subList(0, mean),
					vector.subList(mean, vector.size()), this.getActivity()
							.getApplicationContext(), this.getFragmentManager());
	...
	public Vector<Vector<String>> getList() throws InterruptedException,
		...
		DataGrabber e = new DataGrabber(this.getActivity()
	 ...
	 * Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.55f, 0,
	 ...
	 * TranslateAnimation.RELATIVE_TO_SELF, 0.0f, 0, 0.0f, 0, 0.0f); } return
	 * isExpanded; }
	 */
